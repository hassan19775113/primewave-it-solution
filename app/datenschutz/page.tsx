...
const content = {
  ...
  ar: {
    ...
    section1: {
      ...
      text: "توفر المعلومات التالية نظرة عامة بسيطة على ما يحدث لبياناتك الشخصية عند زيارة هذا الموقع. البيانات الشخصية هي أي بيانات يمكن من خلالها التعرف عليك شخصياً. للحصول على معلومات مفصلة حول حماية البيانات، يرجى الرجوع إلى سياسة الخصوصية المدرجة أدناه."
    },
    section2: {
      title: "2. جمع البيانات على هذا الموقع",
      q1: {
        title: "من المسؤول عن جمع البيانات على هذا الموقع؟",
        text: "تتم معالجة البيانات على هذا الموقع من قبل مشغل الموقع. يمكنك العثور على تفاصيل الاتصال بالمشغل في قسم 'معلومات عن الطرف المسؤول' في سياسة الخصوصية هذه."
      },
      q2: {
        title: "كيف نجمع بياناتك؟",
        text1: "من ناحية، يتم جمع بياناتك من خلال تقديمك لها لنا. قد تكون هذه بيانات تدخلها في نموذج اتصال، على سبيل المثال.",
        text2: "يتم جمع بيانات أخرى تلقائياً أو بموافقتك عند زيارة الموقع بواسطة أنظمة تكنولوجيا المعلومات لدينا. هذه في الغالب بيانات تقنية (مثل متصفح الإنترنت أو نظام التشغيل أو وقت الوصول إلى الصفحة). يتم جمع هذه البيانات تلقائياً بمجرد دخولك إلى هذا الموقع."
      },
      q3: {
        title: "لماذا نستخدم بياناتك؟",
        text: "يتم جمع بعض البيانات لضمان توفير الموقع بدون أخطاء. قد يتم استخدام بيانات أخرى لتحليل سلوك المستخدم الخاص بك."
      },
      q4: {
        title: "ما هي حقوقك فيما يتعلق ببياناتك؟",
        text1: "لديك الحق في أي وقت في الحصول على معلومات مجانية حول أصل ومستلم والغرض من بياناتك الشخصية المخزنة. لديك أيضاً الحق في طلب تصحيح أو حذف هذه البيانات. إذا كنت قد أعطيت موافقة على معالجة البيانات، يمكنك إلغاء هذه الموافقة في أي وقت للمستقبل. لديك أيضاً الحق في طلب تقييد معالجة بياناتك الشخصية في ظروف معينة. علاوة على ذلك، لديك الحق في تقديم شكوى إلى السلطة الإشرافية المختصة.",
        text2: "لهذا والأسئلة الأخرى المتعلقة بحماية البيانات، يمكنك الاتصال بنا في أي وقت."
      }
    },
    section3: { title: "3. الاستضافة", text: "نستضيف محتوى موقعنا مع المزود التالي:", subtitle: "الاستضافة الخارجية", text1: "يتم استضافة هذا الموقع خارجياً. يتم تخزين البيانات الشخصية التي يتم جمعها على هذا الموقع على خوادم المضيف (المضيفين).", text2: "يتم إجراء الاستضافة الخارجية لغرض الوفاء بالعقد تجاه عملائنا المحتملين والحاليين ولصالح توفير آمن وسريع وفعال لعرضنا عبر الإنترنت من قبل مزود محترف.", text3: "سيعالج المضيف (المضيفون) بياناتك فقط بالقدر اللازم للوفاء بالتزامات الخدمة واتباع تعليماتنا فيما يتعلق بهذه البيانات." },
    section4: { title: "4. معلومات عامة وإلزامية", subtitle: "حماية البيانات", text1: "يأخذ مشغلو هذه الصفحات حماية بياناتك الشخصية على محمل الجد. نعامل بياناتك الشخصية بسرية ووفقاً للوائح حماية البيانات القانونية وسياسة الخصوصية هذه.", text2: "عندما تستخدم هذا الموقع، يتم جمع بيانات شخصية مختلفة. هذه سياسة الخصوصية تشرح البيانات التي نجمعها وما نستخدمها من أجله.", text3: "نود أن نشير إلى أن نقل البيانات عبر الإنترنت (مثل التواصل عبر البريد الإلكتروني) قد يكون له ثغرات أمنية. الحماية الكاملة للبيانات من الوصول من قبل أطراف ثالثة غير ممكنة." },
    section5: { title: "5. معلومات عن الطرف المسؤول", text1: "الطرف المسؤول عن معالجة البيانات على هذا الموقع هو:", company: "Primewave IT Solution", address1: "Musterstraße 123", address2: "12345 Musterstadt", phone: "الهاتف: +49 (0) 123 456789", email: "البريد الإلكتروني: info@primewave-it.de", text2: "الطرف المسؤول هو الشخص الطبيعي أو الاعتباري الذي يحدد بمفرده أو بالاشتراك مع آخرين أغراض ووسائل معالجة البيانات الشخصية." },
    section6: { title: "6. مدة التخزين", text: "ما لم يتم تحديد مدة تخزين أكثر تحديداً ضمن سياسة الخصوصية هذه، ستبقى بياناتك الشخصية معنا حتى لا ينطبق الغرض من معالجة البيانات." },
    section7: { title: "7. نموذج الاتصال", text1: "إذا أرسلت لنا استفسارات عبر نموذج الاتصال، سيتم تخزين تفاصيلك من نموذج الاستفسار من قبلنا لغرض معالجة الاستفسار.", text2: "تستند معالجة هذه البيانات إلى موافقتك أو مصلحتنا المشروعة في معالجة الاستفسارات الموجهة إلينا بشكل فعال.", text3: "ستبقى البيانات التي تدخلها في نموذج الاتصال معنا حتى تطلب الحذف." },
    section8: { title: "8. الاستفسار عبر البريد الإلكتروني أو الهاتف", text1: "إذا اتصلت بنا عبر البريد الإلكتروني أو الهاتف، سيتم تخزين ومعالجة استفسارك من قبلنا لغرض التعامل مع طلبك.", text2: "تستند معالجة هذه البيانات إلى موافقتك أو مصلحتنا المشروعة.", text3: "ستبقى البيانات المرسلة إلينا معنا حتى تطلب الحذف." },
    section9: { title: "9. تشفير SSL أو TLS", text1: "لأسباب أمنية ولحماية نقل المحتوى السري، يستخدم هذا الموقع تشفير SSL أو TLS.", text2: "عندما يتم تفعيل تشفير SSL أو TLS، لا يمكن قراءة البيانات التي ترسلها إلينا من قبل أطراف ثالثة." },
    section10: { title: "10. حقوقك", text: "بموجب اللائحة العامة لحماية البيانات، لديك حقوق مختلفة:", rights: ["الحق في المعلومات", "الحق في التصحيح", "الحق في المحو", "الحق في تقييد المعالجة", "الحق في نقل البيانات", "الحق في الاعتراض", "الحق في تقديم شكوى"] },
    backButton: "العودة إلى الصفحة الرئيسية"
  },
  ku: {
    title: "سیاسەتی تایبەتمەندی",
    section1: { title: "1. تایبەتمەندی بە کورتی", subtitle: "زانیاری گشتی", text: "زانیارییە خوارەوەکان تێڕوانینێکی سادە دەبەخشێت لەسەر ئەوەی چی بۆ دراوەکانی کەسیت ڕوودەدات کاتێک سەردانی ئەم ماڵپەڕە دەکەیت." },
    section2: { title: "2. کۆکردنەوەی دراوە لەسەر ئەم ماڵپەڕە", q1: { title: "کێ بەرپرسیارە لە کۆکردنەوەی دراوە لەسەر ئەم ماڵپەڕە؟", text: "پرۆسەی دراوە لەسەر ئەم ماڵپەڕە لەلایەن بەڕێوەبەری ماڵپەڕەوە ئەنجام دەدرێت." }, q2: { title: "چۆن دراوەکانت کۆدەکەینەوە؟", text1: "دراوەکانت لەلایەک کۆدەکرێنەوە بەوەی تۆ پێمان دەدەیت.", text2: "دراوەی تر بە شێوەی خۆکار یان بە ڕەزامەندیت کاتێک سەردانی ماڵپەڕەکە دەکەیت لەلایەن سیستەمەکانی IT مانەوە کۆدەکرێنەوە." }, q3: { title: "بۆچی دراوەکانت بەکاردەهێنین؟", text: "بەشێک لە دراوەکان کۆدەکرێنەوە بۆ دڵنیابوون لە دابینکردنی ماڵپەڕە بەبێ هەڵە." }, q4: { title: "چ مافێکت هەیە سەبارەت بە دراوەکانت؟", text1: "لە هەر کاتێکدا مافی ئەوەت هەیە کە زانیاری بەخۆڕایی وەربگریت دەربارەی سەرچاوە و وەرگر و مەبەستی دراوە کەسییە هەڵگیراوەکانت.", text2: "بۆ ئەمە و پرسیارەکانی تری سەبارەت بە پاراستنی دراوە، دەتوانیت لە هەر کاتێکدا پەیوەندیمان پێوە بکەیت." } },
    section3: { title: "3. میوانداری", text: "ئێمە ناوەڕۆکی ماڵپەڕەکەمان لەلای دابینکەری خوارەوە میواندار دەکەین:", subtitle: "میوانداری دەرەکی", text1: "ئەم ماڵپەڕە لە دەرەوە میواندار دەکرێت.", text2: "میوانداری دەرەکی بۆ مەبەستی جێبەجێکردنی گرێبەست ئەنجام دەدرێت.", text3: "میواندارەکە(کان)مان تەنها دراوەت پرۆسێس دەکەن بەو ڕادەیەی پێویستە." },
    section4: { title: "4. زانیاری گشتی و پێویست", subtitle: "پاراستنی دراوە", text1: "بەڕێوەبەرانی ئەم لاپەڕانە پاراستنی دراوەی کەسیت بە جدی وەردەگرن.", text2: "کاتێک ئەم ماڵپەڕە بەکاردەهێنیت، دراوەی کەسی جۆراوجۆر کۆدەکرێنەوە.", text3: "ئێمە دەمانەوێت ئاماژە بەوە بکەین کە گواستنەوەی دراوە لە ئینتەرنێتدا کەموکوڕی ئاسایشی هەبێت." },
    section5: { title: "5. زانیاری دەربارەی لایەنی بەرپرسیار", text1: "لایەنی بەرپرسیار بۆ پرۆسەی دراوە لەسەر ئەم ماڵپەڕە:", company: "Primewave IT Solution", address1: "Musterstraße 123", address2: "12345 Musterstadt", phone: "تەلەفۆن: +49 (0) 123 456789", email: "ئیمەیڵ: info@primewave-it.de", text2: "لایەنی بەرپرسیار کەسە سروشتی یان یاسایییە." },
    section6: { title: "6. ماوەی هەڵگرتن", text: "مەگەر ماوەی هەڵگرتنی تایبەتتر دیاری نەکرابێت، دراوەکانی کەسیت لەگەڵماندا دەمێنێتەوە." },
    section7: { title: "7. فۆڕمی پەیوەندی", text1: "ئەگەر پرسیارمان بۆ بنێریت لە ڕێگەی فۆڕمی پەیوەندیەوە، وردەکارییەکانت لەلایەن ئێمەوە هەڵدەگیرێن.", text2: "پرۆسەی ئەم دراوانە لەسەر بنەمای ڕەزامەندیت یان بەرژەوەندی یاسایی ئێمە.", text3: "دراوەکان کە لە فۆڕمی پەیوەندیدا دەنووسیت لەگەڵماندا دەمێنێتەوە." },
    section8: { title: "8. پرسیار لە ڕێگەی ئیمەیڵ یان تەلەفۆن", text1: "ئەگەر پەیوەندیمان پێوە بکەیت لە ڕێگەی ئیمەیڵ یان تەلەفۆنەوە، پرسیارەکەت هەڵدەگیرێت.", text2: "پرۆسەی ئەم دراوانە لەسەر بنەمای ڕەزامەندیت.", text3: "دراوەکان کە بۆمان دەنێریت لەگەڵماندا دەمێنێتەوە." },
    section9: { title: "9. ڕمزکردنی SSL یان TLS", text1: "بۆ هۆکاری ئاسایش، ئەم ماڵپەڕە ڕمزکردنی SSL یان TLS بەکاردەهێنێت.", text2: "کاتێک ڕمزکردنی SSL یان TLS چالاک دەکرێت، دراوەکان کە بۆمان دەنێریت ناتوانرێت لەلایەن لایەنی سێیەمەوە بخوێنرێتەوە." },
    section10: { title: "10. مافەکانت", text: "لە ژێر GDPR، مافی جۆراوجۆرت هەیە:", rights: ["مافی زانیاری", "مافی ڕاستکردنەوە", "مافی سڕینەوە", "مافی سنووردارکردنی پرۆسە", "مافی گواستنەوەی دراوە", "مافی ناڕەزایی", "مافی سکاڵاکردن"] },
