  ...
  const content = {
    ...
    ar: {
      ...
      pricing: [
        ...
        { name: "الأعمال", price: "€9.999,–", desc: "للشركات المتنامية", features: ["كل شيء من بدء التشغيل +", "ما يصل إلى 15 صفحة", "CMS Headless", "تكامل الرسائل الإخبارية", "SEO متقدم", "A/B Testing", "Heatmaps", "أولوية الدعم"] },
    ...
    ku: {
      ...
      pricing: [
        ...
        { name: "بازرگانی", price: "€9.999,–", desc: "بۆ کۆمپانیای گەشەکەر", features: ["هەموو شتێک لە دەستپێکردن +", "تا 15 لاپەڕە", "CMS Headless", "یەکگرتنی نامە", "SEO ی پێشکەوتوو", "تاقیکردنەوەی A/B", "Heatmaps", "پشتگیری پێشینە"] },
