...
export default function UiUxPage() {
  ...
  const content = {
    ...
    ar: {
      heroBadge: "UI/UX وتصميم التجربة",
      heroTitle: "تصميم يُفهم ويتصرف",
      heroDesc: "لا نصمم بجمال فقط — نصمم بذكاء. مع بحث المستخدم، أنظمة التصميم، والاختبارات المستمرة، نبني واجهات تُقاس بالنتائج.",
      ctaPrimary: "طلب تصميم",
      ctaSecondary: "ادمج مع التطوير",
      benefitsTitle: "تصميم بالبحت، ليس بالحدس",
      benefitsSubtitle: "تصميم قائم على الأدلة لنتائج أفضل قابلة للقياس",
      benefits: [
        { title: "البحث قبل التصميم", description: "لا نصمم من الإحساس — بحث المستخدم، المقابلات، والتحليلات توجه كل قرار تصميم" },
        { title: "عمليات أصلية في Figma", description: "تصميم تعاوني مع نماذج أولية عالية الدقة، مكتبات مكونات، ونظام تصميم مع إصدارات" },
        { title: "إمكانية الوصول أولاً", description: "معيار WCAG 2.1 AA لجميع التصميمات — واجهات يمكن الوصول إليها لقاعدة مستخدمين واسعة" },
        { title: "أنظمة التصميم", description: "مكونات قابلة للتوسع، رموز، إرشادات — للاتساق عبر الحدود الزمنية والمكانية" },
        { title: "تسليم للمطور", description: "مواصفات نظيفة، رموز، أصول — التطوير يصبح أسرع وأسهل وبدون أخطاء" },
        { title: "الاختبار المستمر", description: "اختبارات A/B، خرائط الحرارة، جلسات قابلية الاستخدام — قرارات التصميم تُحقق مع بيانات مستخدمين حقيقيين" }
      ],
      featuresTitle: "محفظة تصميمنا",
      features: [
        ...
        "إنشاء نظام التصميم",
        "مكتبة المكونات",
        "رموز ومتغيرات التصميم",
        "نماذج أولية تفاعلية",
        "اختبار قابلية الاستخدام",
        "مراجعة إمكانية الوصول (WCAG)",
        "تسليم من التصميم للتطوير",
        "الحركة والتفاعلات الدقيقة"
      ],
      processTitle: "عملية التصميم الخاصة بنا",
      processSteps: [
        { title: "سبرينت الاكتشاف", description: "1-2 أسبوع: مقابلات أصحاب المصلحة، بحث المستخدم، تحليل تنافسي. النتيجة: رؤى وملخص تصميم" },
        { title: "الاستراتيجية والتخطيط", description: "2-3 أسابيع: بنية المعلومات، رحلات المستخدم، الإطارات السلكية. ورش عمل ملاحظات مع الفريق" },
        { title: "مراحل التصميم", description: "4-8 أسابيع: تصاميم Low-Fi → Mid-Fi → High-Fi. تكرارات متعددة مع حلقات ملاحظات" },
        { title: "التنفيذ والدعم", description: "تسليم من التصميم للتطوير، التوفر لأسئلة التطوير ومراجعات التصميم أثناء التنفيذ" },
        { title: "الاختبار والتحسين", description: "اختبارات A/B، اختبار قابلية الاستخدام، تحليل خرائط الحرارة. تحسينات مستمرة بناءً على ملاحظات المستخدم" }
      ],
      useCasesTitle: "تصميم يحتاج أشكالاً مختلفة",
      useCases: [
        { title: "تصميم لوحة SaaS", description: "تصور بيانات معقد، تدفقات عمل وتحديثات في الوقت الفعلي لمستخدمي المؤسسات", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1400&auto=format&fit=crop" },
        { title: "إعادة تصميم التجارة الإلكترونية", description: "تجربة متجر Mobile-First، تحسين الدفع، تألق المنتج وإشارات الثقة", image: "https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=1400&auto=format&fit=crop" },
        { title: "تصميم تطبيق الجوال", description: "تصميم iOS/Android أصلي، تفاعلات دقيقة، وظائف بدون اتصال وأداء", image: "https://images.unsplash.com/photo-1512941691920-25bda36dc643?q=80&w=1400&auto=format&fit=crop" },
        { title: "بناء نظام التصميم", description: "مكتبة مكونات قابلة للتوسع مع رموز، توثيق، وتصديرات صديقة للمطورين", image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=1400&auto=format&fit=crop" }
      ],
      philosophyTitle: "فلسفة التصميم الخاصة بنا",
      philosophyItems: [
        { title: "قائم على البحث", desc: "كل قرار تصميم يعتمد على بحث المستخدم، البيانات، وملاحظات المستخدم الحقيقية" },
        { title: "إمكانية الوصول", desc: "معيار WCAG 2.1 AA وتصميم شامل للجميع — ليس لبعض المستخدمين فقط" },
        { title: "قابلية التوسع", desc: "أنظمة تصميم، مكونات ورموز للاتساق — حتى عندما تنمو الفرق" },
        { title: "الأداء", desc: "تصاميم تحمّل بسرعة وسلسة — على جميع الأجهزة وظروف الشبكة" },
        { title: "تكراري", desc: "تكرار سريع وتحسين مستمر — ليس مثالياً عند الإطلاق، بل لاحقاً" },
        { title: "موجه بالنتائج", desc: "نقيس النجاح بمؤشرات الأداء — التحويل، المشاركة، رضا المستخدم — ليس فقط الجماليات" }
      ],
      stats: [{ label: "مشاريع التصميم", value: "54+" }, { label: "أنظمة التصميم", value: "18+" }, { label: "متوسط درجة قابلية الاستخدام", value: "8.2/10" }],
      pricingTitle: "حزم التصميم",
      pricing: [
        { name: "تحديث UX/UI", price: "€3.999,–", desc: "تحسينات طفيفة", features: ["مراجعة وتحليل", "إطارات سلكية", "تحسينات UI", "نماذج أولية", "جولات ملاحظات"] },
        { name: "تصميم كامل", price: "€9.999,–", desc: "إعادة تصميم كاملة", features: ["بحث المستخدم", "إعادة تصميم كاملة", "نماذج عالية الدقة", "نماذج تفاعلية", "نظام التصميم", "تسليم للمطور"], popular: true },
        { name: "مؤسسة", price: "€19.999+", desc: "أنظمة كبيرة ومعقدة", features: ["بحث عميق", "سبرينتات متعددة", "نظام تصميم مخصص", "اختبار قابلية الاستخدام", "تصميم اختبار A/B", "دعم مستمر"] }
      ],
      faqTitle: "أسئلة التصميم الشائعة",
      faqs: [
        { q: "هل التصاميم جاهزة للنموذج الأولي؟", a: "نعم! جميع التصاميم تُنشأ كنماذج Figma تفاعلية مع تفاعلات دقيقة. يمكن للمطورين العمل مباشرة مع المواصفات." },
        { q: "ما هو نظام التصميم؟", a: "مجموعة من المكونات القابلة لإعادة الاستخدام، والرموز، والإرشادات. يمكّن هذا من تطوير أسرع، والاتساق، والتوسع الأسهل عبر الفرق." },
        { q: "كم جولة مراجعة؟", a: "عادة 2-3 جولات ملاحظات لكل مرحلة تصميم. نحن مرنون — المزيد ممكن، لكن مخطط مع المشاريع طويلة المدى." },
        { q: "هل تعملون مع الوكالات؟", a: "نعم! يمكننا العمل كشركاء تصميم لوكالات أخرى، تقديم تصاميم بعلامة بيضاء، أو التصميم معاً مع فريقك." },
        { q: "هل يمكنكم التنفيذ أيضاً؟", a: "نحن نصمم — يمكن لفريق التطوير لدينا معالجة التنفيذ أو يمكنك العمل مع فريقك. تعاون سلس." }
      ],
      ctaTitle: "هل أنت مستعد لتصميم قائم على البحث؟",
      ctaDesc: "دعنا نحوّل رؤيتك مع البيانات وبحث المستخدم إلى تصميم رائع.",
      ctaButton: "طلب تصميم",
      ctaBack: "العودة إلى الصفحة الرئيسية",
      popularBadge: "شائع"
    },
    ku: {
      heroBadge: "UI/UX و دیزاینی ئەزموون",
      heroTitle: "دیزاین کە تێدەگەیت و کار دەکات",
      heroDesc: "ئێمە تەنها جوان دیزاین ناکەین — زیرەکانە دیزاین دەکەین. لەگەڵ لێکۆڵینەوەی بەکارهێنەر، سیستەمی دیزاین، و تاقیکردنەوەی بەردەوام، ڕوویەکان دروست دەکەین کە بە ئەنجام پێوان دەکرێن.",
      ctaPrimary: "داواکاری دیزاین",
      ctaSecondary: "یەک بخە لەگەڵ گەشەپێدان",
      benefitsTitle: "دیزاین بە لێکۆڵینەوە، نەک بە هەست",
      benefitsSubtitle: "دیزاینی لەسەر بەڵگە بۆ ئەنجامی پێوانەکراو باشتر",
      benefits: [
        { title: "لێکۆڵینەوە پێش دیزاین", description: "ئێمە لە هەستی زگ دیزاین ناکەین — لێکۆڵینەوەی بەکارهێنەر، چاوپێکەوتنەکان، و شیکاری هەر بڕیاری دیزاین ڕێنمایی دەکەن" },
        { title: "پرۆسەی ڕەسەنی Figma", description: "دیزاینی هاوکاری لەگەڵ نموونەی بەرز-دڵنیایی، کتێبخانەی پێکهاتەکان، و سیستەمی دیزاینی نوسخەکراو" },
        { title: "دەستگەیشتن یەکەم", description: "ستانداردی WCAG 2.1 AA بۆ هەموو دیزاینەکان — ڕوویەکانی دەستگەیشتن بۆ بنکەیەکی فرەی بەکارهێنەر" },
        { title: "سیستەمی دیزاین", description: "پێکهاتەی گەورەکراو، تۆکن، ڕێنمایی — بۆ یەکدەنگی لە سەرانسەری کات و شوێن" },
        { title: "رادەستی گەشەپێدەر", description: "تایبەتمەندیی پاک، تۆکن، دارایی — گەشەپێدان خێراتر، ئاسانتر، و بێ هەڵە دەبێت" },
        { title: "تاقیکردنەوەی بەردەوام", description: "تاقیکردنەوەی A/B، نەخشەی گەرما، دانیشتنی بەکارهێنان — بڕیارەکانی دیزاین لەگەڵ داتای بەکارهێنەری ڕاستەقینە پەسەند دەکرێن" }
      ],
      featuresTitle: "پۆرتفۆلیۆی دیزاینمان",
      features: [
        "لێکۆڵینەوەی بەکارهێنەر و کەسایەتی",
        "نەخشەکردنی گەشتی بەکارهێنەر",
        "چوارچێوەی تەل و نموونەی یەکەم",
        "دیزاینی UI ی بەرز-دڵنیایی",
        "دروستکردنی سیستەمی دیزاین",
        "کتێبخانەی پێکهاتە",
        "تۆکن و گۆڕانکارییەکانی دیزاین",
        "نموونەی کارلێکەر",
        "تاقیکردنەوەی بەکارهێنان",
        "پێداچوونەوەی دەستگەیشتن (WCAG)",
        "رادەستی لە دیزاین بۆ گەشەپێدان",
        "جوڵە و کارلێکەری وردەکان"
      ],
      processTitle: "پرۆسەی دیزاینمان",
      processSteps: [
        { title: "سپرینتی دۆزینەوە", description: "1-2 هەفتە: چاوپێکەوتن لەگەڵ لایەنگران، لێکۆڵینەوەی بەکارهێنەر، شیکاریی ڕکابەری. ئەنجام: تێبینی و کورتەی دیزاین" },
        { title: "ستراتیژ و پلاندانان", description: "2-3 هەفتە: تەلارسازیی زانیاری، گەشتی بەکارهێنەر، چوارچیوەی تەل. وۆرکشۆپی فیدباک لەگەڵ تیم" },
        { title: "قۆناغەکانی دیزاین", description: "4-8 هەفتە: دیزاینی Low-Fi → Mid-Fi → High-Fi. دووبارەی زۆر لەگەڵ خولی فیدباک" },
        { title: "جێبەجێکردن و پشتگیری", description: "رادەستی لە دیزاین بۆ گەشەپێدان، بەردەستبوون بۆ پرسیاری گەشەپێدان و پێداچوونەوەی دیزاین لە کاتی جێبەجێکردن" },
        { title: "تاقیکردنەوە و باشکردن", description: "تاقیکردنەوەی A/B، تاقیکردنەوەی بەکارهێنان، شیکاری نەخشەی گەرما. باشکردنی بەردەوام لەسەر بنەمای فیدباکی بەکارهێنەر" }
      ],
      useCasesTitle: "دیزاین پێویستی شێوازی جیاواز هەیە",
      useCases: [
        { title: "دیزاینی داشبۆردی SaaS", description: "وێناکردنی داتای ئاڵۆز، کارفلۆ و نوێکردنەوەی کاتی-ڕاستەقینە بۆ بەکارهێنەری دامەزراوە", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1400&auto=format&fit=crop" },
        { title: "دووبارە دیزاینی بازرگانی ئەلیکترۆنی", description: "ئەزموونی فرۆشگای یەکەمی مۆبایل، باشکردنی پارەدان، درەوشانی بەرهەم و نیشانەی متمانە", image: "https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=1400&auto=format&fit=crop" },
        { title: "دیزاینی ئەپی مۆبایل", description: "دیزاینی ڕەسەنی iOS/Android، کارلێکەری وردەکان، تایبەتمەندیی نادەرهێڵ و کارایی", image: "https://images.unsplash.com/photo-1512941691920-25bda36dc643?q=80&w=1400&auto=format&fit=crop" },
        { title: "دروستکردنی سیستەمی دیزاین", description: "کتێبخانەی پێکهاتەی گەورەکراو لەگەڵ تۆکن، دۆکیومێنت، و هەناردەی دۆستانەی گەشەپێدەران", image: "https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=1400&auto=format&fit=crop" }
      ],
      philosophyTitle: "فەلسەفەی دیزاینمان",
      philosophyItems: [
        { title: "بنەما-لێکۆڵینەوە", desc: "هەر بڕیاری دیزاین لەسەر لێکۆڵینەوەی بەکارهێنەر، داتا، و فیدباکی بەکارهێنەری ڕاستەقینە دامەزراوە" },
        { title: "دەستگەیشتن", desc: "ستانداردی WCAG 2.1 AA و دیزاینی گشتگیر بۆ هەمووان — نەک تەنها بۆ هەندێک بەکارهێنەر" },
        { title: "گەورەکردن", desc: "سیستەمی دیزاین، پێکهاتە و تۆکن بۆ یەکدەنگی — تەنانەت کاتیک تیمەکان گەشە دەکەن" },
        { title: "کارایی", desc: "دیزاینەکان خێرا بار دەبن و نەرمن — لەسەر هەموو ئامێرەکان و بارودۆخی تۆڕ" },
        { title: "دووبارەکراوە", desc: "دووبارەکردنەوەی خێرا و باشکردنی بەردەوام — نەک تەواو لە دەس  پێکردن، بەڵکوو دواتر" },
        { title: "ئەنجام-ڕووکراوە", desc: "ئێمە سەرکەوتن لەسەر KPI پێوان دەکەین — گۆڕین، بەشداریکردن، ڕەزامەندیی بەکارهێنەر — نەک تەنها جوانی" }
      ],
      stats: [{ label: "پرۆژەی دیزاین", value: "54+" }, { label: "سیستەمی دیزاین", value: "18+" }, { label: "ناوەندی نمرەی بەکارهێنان", value: "8.2/10" }],
      pricingTitle: "پاکێجی دیزاین",
      pricing: [
        { name: "نوێکردنەوەی UX/UI", price: "€3.999,–", desc: "باشکردنی بچووک", features: ["پێداچوونەوە و شیکاری", "چوارچیوەکان", "باشکردنی UI", "نموونەی یەکەم", "خولی فیدباک"] },
        { name: "دیزاینی تەواو", price: "€9.999,–", desc: "دووبارە دیزاینی تەواو", features: ["لێکۆڵینەوەی بەکارهێنەر", "دووبارە دیزاینی تەواو", "نموونەی بەرز-دڵنیایی", "نموونەی کارلێکەر", "سیستەمی دیزاین", "رادەستی گەشەپێدەر"], popular: true },
        { name: "دامەزراوە", price: "€19.999+", desc: "سیستەمی گەورە و ئاڵۆز", features: ["لێکۆڵینەوەی قووڵ", "چەندین سپرینت", "سیستەمی دیزاینی تایبەت", "تاقیکردنەوەی بەکارهێنان", "دیزاینی تاقیکردنەوەی A/B", "پشتگیری بەردەوام"] }
      ],
      faqTitle: "پرسیارە باوەکانی دیزاین",
      faqs: [
        { q: "ئایا دیزاینەکان ئامادەن بۆ نموونەی یەکەم؟", a: "بەڵێ! هەموو دیزاینەکان وەک نموونەی Figma ی کارلێکەر لەگەڵ کارلێکەری وردەکان دروست دەکرێن. گەشەپێدەران دەتوانن ڕاستەوخۆ لەگەڵ تایبەتمەندییەکان کار بکەن." },
        { q: "سیستەمی دیزاین چییە؟", a: "کۆمەڵەیەک لە پێکهاتەی دووبارە بەکارهێنان، تۆکن و ڕێنمایی. ئەمە ڕێگا دەدات بە گەشەپێدانی خێراتر، یەکدەنگی و فراوانکردنی ئاسانتر لە ناو تیمەکاندا." },
        { q: "چەند خولی پێداچوونەوە؟", a: "بەشێوەیەکی ئاسایی 2-3 خولی فیدباک بۆ هەر قۆناغی دیزاین. ئێمە نەرمین — زیاتر دەکرێت، بەڵام لەگەڵ پرۆژەی درێژخایەن پلان دەکرێت." },
        { q: "ئایا لەگەڵ ئەجێنسییەکان کار دەکەن؟", a: "بەڵێ! دەتوانین وەک هاوبەشی دیزاین بۆ ئەجێنسیی تر کار بکەین، دیزاینی لیبلی سپی دابین دەست، یان لەگەڵ تیمتان پێکەوە دیزاین بکەین." },
        { q: "دەتوانن جێبەجێکردنیش بکەن؟", a: "ئێمە دیزاین دەکەین — جێبەجێکردن دەتوانیت تیمی گەشەپێدانمان مامەڵەی پێ بکات یان لەگەڵ تیمی خۆت کار بکەیت. هاوکاریی نەرم." }
      ],
      ctaTitle: "ئامادەیت بۆ دیزاینی لێکۆڵینەوە-بنەما؟",
      ctaDesc: "با دیدگاکەت لەگەڵ داتا و لێکۆڵینەوەی بەکارهێنەر بگۆڕین بۆ دیزاینی نایاب.",
      ctaButton: "داواکاری دیزاین",
      ctaBack: "گەڕانەوە بۆ سەرەتا",
      popularBadge: "بەناوبانگ"
    }
  };
