...
export default function SeoPage() {
  ...
  const content = {
    ...
    ar: {
      heroBadge: "SEO وتحسين محركات البحث",
      heroTitle: "رؤية في Google – مستدامة ومربحة",
      heroDesc: "لا تُنسى، بل اجعل المستخدمين يجدونك. نحسّن موقعك الإلكتروني لترتيب أفضل، والمزيد من الزوار المؤهلين، ونتائج عمل حقيقية. بدون ميزانيات إعلانية. مستدام.",
      ctaPrimary: "اطلب تدقيق SEO",
      ctaSecondary: "ادمج الموقع + SEO",
      benefitsTitle: "لماذا SEO له أفضل عائد استثمار",
      benefitsSubtitle: "المزيد من الزوار المؤهلين بدون دفع مستمر للإعلانات",
      benefits: [
        { title: "زوار مؤهلون", description: "الأشخاص الذين يبحثون عن خدماتك يجدونك – بشكل عضوي ومجاني بعد الترتيب الأول." },
        { title: "مستدام وموفر للتكاليف", description: "على عكس الإعلانات: الترتيبات تعزز نفسها. محسّن مرة واحدة = رؤية طويلة الأمد، بدون ميزانيات إعلانية شهرية." },
        { title: "بناء المصداقية", description: "المركز 1 في Google = ثقة العلامة التجارية. المستخدمون ينقرون على أعلى 3 – وليس على الصفحة 5. SEO جزء من استراتيجية علامتك التجارية." },
        { title: "التركيز على التحويل", description: "نحن نحسّن ليس فقط للترتيبات، بل للاستفسارات والمبيعات الحقيقية. نية المستخدم مهمة، وليس النقرات فقط." },
        { title: "قابل للقياس وشفاف", description: "كل قرار يستند إلى البيانات. نعرض مؤشرات أداء رئيسية واضحة: الترتيبات، الزيارات، معدل التحويل، ROI." },
        { title: "ميزة تنافسية", description: "منافسوك نائمون – أو ليسوا كذلك. مع SEO المُعطى الأولوية تتجاوزهم وتهيمن على مكانتك." }
      ],
      featuresTitle: "نطاق خدمة SEO لدينا",
      features: ["بحث الكلمات المفتاحية والاستراتيجية", "تدقيق SEO التقني والإصلاحات", "تحسين الصفحة", "تحسين Core Web Vitals", "Schema Markup و Rich Snippets", "استراتيجية الربط الداخلي", "استراتيجية المحتوى والكتلة", "تحليل وبناء الروابط الخلفية", "SEO المحلي و Google Business", "إعداد Google Search Console", "تحليل المنافسة", "تقارير وتتبع SEO الشهرية"],
      processTitle: "عملية SEO لدينا",
      processSteps: [
        { title: "تدقيق وتحليل SEO", description: "نحلل موقعك الإلكتروني والمنافسين وفرص الكلمات المفتاحية. تشخيص واضح بدلاً من التخمين." },
        { title: "الاستراتيجية وخارطة الطريق", description: "إجراءات ذات أولوية، جداول زمنية واقعية. ما الذي يجلب انتصارات سريعة؟ ما هو ذو صلة طويلة الأمد؟" },
        { title: "التنفيذ والتحسين", description: "SEO على الصفحة والتقني، إنشاء المحتوى، الربط الداخلي، استراتيجية الروابط الخلفية – كل شيء منسق." },
        { title: "المراقبة والإبلاغ", description: "تتبع الترتيبات أسبوعياً، تقارير شهرية. تعديلات قائمة على البيانات بدلاً من التخمين." },
        { title: "التحسين المستمر", description: "SEO هو ماراثون، وليس سباق سريع. نحسّن باستمرار ونتكيف مع تحديثات Google الجديدة." }
      ],
      useCasesTitle: "SEO لمختلف الصناعات",
      useCases: [
        { title: "موقع الشركة", description: "الشركات الراسخة التي تتطلع إلى زيادة ظهورها في نتائج البحث وتوليد عملاء محتملين عالي الجودة.", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1400&auto=format&fit=crop" },
        { title: "التجارة الإلكترونية والمتاجر عبر الإنترنت", description: "المتاجر عبر الإنترنت التي تريد الترتيب لكلمات مفتاحية خاصة بالمنتجات وزيادة الإيرادات العضوية.", image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=1400&auto=format&fit=crop" },
        { title: "الخدمات المحلية", description: "الحرفيون، الوكالات، الاستوديوهات: الترتيب للبحث المحلي ورؤية خرائط Google.", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1400&auto=format&fit=crop" },
        { title: "المحتوى والنشر", description: "المدونات، مواقع الأخبار، المجلات: استراتيجية الزيارات العضوية للقراء المنتظمين والمشاركة.", image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?q=80&w=1400&auto=format&fit=crop" }
      ],
      toolsTitle: "أفضل أدوات وخدمات SEO",
      techStack: ["Google Search Console", "Google Analytics 4", "Semrush / Ahrefs", "Screaming Frog SEO Spider", "Lighthouse & PageSpeed Insights", "Google Keyword Planner", "SEMrush / Moz", "CanIRank", "Yoast / RankMath", "أدوات مراقبة الروابط الخلفية"],
      stats: [{ label: "مشاريع SEO", value: "47+" }, { label: "متوسط تحسين الترتيب", value: "+287%" }, { label: "زيادة الزيارات", value: "+342%" }],
      pricingTitle: "باقات SEO",
      pricing: [
        { name: "تدقيق SEO", price: "€1.999,–", desc: "تحليل لمرة واحدة", features: ["تحليل الموقع", "بحث الكلمات المفتاحية", "تحليل المنافسين", "تدقيق 30+ صفحة", "تقرير قابل للتنفيذ"] },
        { name: "إدارة SEO", price: "€3.999/شهر", desc: "التحسين المستمر", features: ["كل شيء من التدقيق +", "استراتيجية شهرية", "تحسين الصفحة", "بناء الروابط الخلفية", "تتبع الترتيب", "الإبلاغ الشهري"], popular: true },
        { name: "SEO + التطوير", price: "€6.999/شهر", desc: "الحزمة الكاملة", features: ["كل شيء من الإدارة +", "تطوير الموقع", "إنشاء المحتوى", "الإعداد التقني", "التكامل الكامل", "المراجعات الفصلية"] }
      ],
      faqTitle: "الأسئلة الشائعة عن SEO",
      faqs: [
        { q: "كم من الوقت حتى أرى الترتيبات؟", a: "4-12 أسبوع للتحسينات الأولية، 3-6 أشهر للحركة الكبيرة. Google يستغرق وقتاً. لكن بمجرد أن يعمل، يعمل لفترة طويلة." },
        { q: "هل SEO تكلفة شهرية؟", a: "نعم – SEO هو ماراثون، وليس سباق سريع. نوصي بالإدارة الشهرية (وليس لمرة واحدة). الحفاظ على الترتيبات = التحسين المستمر." },
        { q: "هل يمكنك ضمان الترتيبات؟", a: "بجدية؟ لا. لا أحد يضمن الترتيبات. Google يغير الخوارزميات باستمرار. نحن نضمن العمل الجيد، الاختبار والتحسين – وليس المركز 1." },
        { q: "لماذا لا نستخدم فقط إعلانات Google؟", a: "لأن SEO أرخص. بعد 6 أشهر لا تزال تدفع مقابل النقرات مع الإعلانات، مع SEO يعمل بشكل عضوي. مثالي: كلاهما معاً في البداية." },
        { q: "هل يمكننا الاحتفاظ بموقعنا الحالي؟", a: "نعم! نحسّن موقعك الحالي. لا انتقال، لا انتقالات طويلة – نمضي قدماً تدريجياً." }
      ],
      ctaTitle: "تريد الظهور في Google؟",
      ctaDesc: "لنبدأ بتحليل مجاني. سنوضح لك أين تكمن فرصك.",
      ctaButton: "ابدأ تدقيق SEO",
      ctaBack: "العودة إلى الصفحة الرئيسية",
      popularBadge: "شائع",
      requestButton: "طلب"
    },
    ku: {
      heroBadge: "SEO و باشکردنی بزوێنەری گەڕان",
      heroTitle: "بینین لە Google – بەردەوام و قازانجێک",
      heroDesc: "لەبیرنەچیت، بەڵکو ڕێگە بدە بەکارهێنەران بتدۆزنەوە. ئێمە ماڵپەڕەکەت باشتر دەکەین بۆ پلەبەندی باشتر، سەردانیکەری زیاتری شایستە، و ئەنجامی کاری ڕاستەقینە. بەبێ بودجەی ڕیکلام. بەردەوام.",
      ctaPrimary: "داوای پشکنینی SEO بکە",
      ctaSecondary: "ماڵپەڕ + SEO تێکەڵ بکە",
      benefitsTitle: "بۆچی SEO باشترین ROI هەیە",
      benefitsSubtitle: "سەردانیکەری زیاتری شایستە بەبێ پارەدانی بەردەوام بۆ ڕیکلامەکان",
      benefits: [
        { title: "سەردانیکەری شایستە", description: "خەڵکانێک کە بەدوای خزمەتگوزارییەکانتدا دەگەڕێن دەتدۆزنەوە – بە شێوەy ئۆرگانیک و بەخۆڕایی دوای پلەبەندی یەکەم." },
        { title: "بەردەوام و پاشەکەوتکار", description: "بەپێچەوانەی ڕیکلامەکان: پلەبەندییەکان خۆیان بەهێز دەکەن. جارێک باشکراو = بینینی درێژخایەن، بەبێ بودجەی ڕیکلامی مانگانە." },
        { title: "متمانەپێکراوی دروستبکە", description: "پلە 1 لە Google = متمانەی مارکە. بەکارهێنەران کلیک لەسەر لووتکەی 3 دەکەن – نەک لەسەر لاپەڕەی 5. SEO بەشێکە لە ستراتیژی مارکەکەت." },
        { title: "سەرنج لەسەر گۆڕین", description: "ئێمە نەک تەنها بۆ پلەبەندی باشتر دەکەین، بەڵکو بۆ پرسیار و فرۆشتنی ڕاستەقینە. نیازی بەکارهێنەر گرنگە، نەک تەنها کلیکەکان." },
        { title: "پێوانکراو و ڕوون", description: "هەموو بڕیارێک لەسەر دراوە بنەما دەنرێت. ئێمە KPIـی ڕوون پیشان دەدەین: پلەبەندی، هاتووچۆ، ڕێژەی گۆڕین، ROI." },
        { title: "سوودی ڕکابەری", description: "ڕکابەرەکانت خەوتوون – یان نا. لەگەڵ SEO ی پێشینەدار تێپەڕیان دەکەیت و دەسەڵاتداری جێگەکەت دەکەیت." }
      ],
      featuresTitle: "بواری خزمەتگوزاریی SEO مان",
      features: ["لێکۆڵینەوەی وشەی سەرەکی و ستراتیژی", "پشکنینی SEO ی تەکنیکی و چاککردنەوەکان", "باشکردنی لەسەر لاپەڕە", "باشکردنی Core Web Vitals", "Schema Markup و Rich Snippets", "ستراتیژی بەستەری ناوخۆیی", "ستراتیژی ناوەڕۆک و کۆمەڵە", "شیکاری و دروستکردنی بەستەری پشتەوە", "SEO ی ناوچەیی و Google Business", "ڕێکخستنی Google Search Console", "شیکاری ڕکابەری", "ڕاپۆرت و شوێنکەوتنی SEO ی مانگانە"],
      processTitle: "پڕۆسەی SEO مان",
      processSteps: [
        { title: "پشکنین و شیکاری SEO", description: "ئێمە ماڵپەڕەکەت و ڕکابەران و هەلی وشەی سەرەکی شی دەکەینەوە. دەسنیشانکردنی ڕوون لەجیاتی گومان." },
        { title: "ستراتیژی و نەخشەی ڕێگا", description: "کردارە پێشینەدارەکان، کاتە ڕاستەقینەکان. چی سەرکەوتنی خێرا دەهێنێت؟ چی دوورودرێژە پەیوەندیداری؟" },
        { title: "جێبەجێکردن و باشکردن", description: "SEO ی لەسەر لاپەڕە و تەکنیکی، دروستکردنی ناوەڕۆک، بەستەری ناوخۆیی، ستراتیژی بەستەری پشتەوە – هەموو هاوکاری." },
        { title: "چاودێری و ڕاپۆرت", description: "شوێنکەوتنی پلەبەندی هەفتانە، ڕاپۆرتی مانگانە. ڕاستکردنەوەی پشتبەستوو بە دراوە لەجیاتی گومان." },
        { title: "باشکردنی بەردەوام", description: "SEO مارەسۆنێکە، نەک ڕاکردنێکی خێرا. ئێمە بەردەوام باشتر دەکەین و خۆمان لەگەڵ نوێکردنەوەی نوێی Google دەگونجێنین." }
      ],
      useCasesTitle: "SEO بۆ پیشەسازیی جیاواز",
      useCases: [
        { title: "ماڵپەڕی کۆمپانیا", description: "کۆمپانیا دامەزراوەکان کە دەیانەوێت بینینیان لە ئەنجامی گەڕاندا زیاد بکەن و سەرچاوەی بەرزی کوالێتی دروست بکەن.", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1400&auto=format&fit=crop" },
        { title: "بازرگانی ئەلیکترۆنی و فرۆشگای ئۆنلاین", description: "فرۆشگای ئۆنلاین کە دەیانەوێت بۆ وشەی سەرەکیی تایبەت بە بەرهەم پلەبەندی بکەن و داهاتی ئۆرگانیک زیاد بکەن.", image: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?q=80&w=1400&auto=format&fit=crop" },
        { title: "خزمەتگوزاریی ناوچەیی", description: "پیشەوەران، ئەنجومەنەکان، ستودیۆکان: پلەبەندی بۆ گەڕانی ناوچەیی و بینینی نەخشەی Google.", image: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=1400&auto=format&fit=crop" },
        { title: "ناوەڕۆک و بڵاوکردنەوە", description: "بلۆگەکان، ماڵپەڕی هەواڵ، گۆڤار: ستراتیژی هاتووچۆی ئۆرگانیک بۆ خوێنەری بەردەوام و بەشداری.", image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?q=80&w=1400&auto=format&fit=crop" }
      ],
      toolsTitle: "باشترین ئامراز و خزمەتگوزارییەکانی SEO",
      techStack: ["Google Search Console", "Google Analytics 4", "Semrush / Ahrefs", "Screaming Frog SEO Spider", "Lighthouse & PageSpeed Insights", "Google Keyword Planner", "SEMrush / Moz", "CanIRank", "Yoast / RankMath", "ئامرازەکانی چاودێری بەستەری پشتەوە"],
      stats: [{ label: "پڕۆژەی SEO", value: "47+" }, { label: "ناوەندی باشبوونی پلەبەندی", value: "+287%" }, { label: "زیادبوونی هاتووچۆ", value: "+342%" }],
      pricingTitle: "پاکێجەکانی SEO",
      pricing: [
        { name: "پشکنینی SEO", price: "€1.999,–", desc: "شیکارییەکی یەکجار", features: ["شیکاری ماڵپەڕ", "لێکۆڵینەوەی وشەی سەرەکی", "شیکاری ڕکابەران", "پشکنینی 30+ لاپەڕە", "ڕاپۆرتی جێبەجێکراو"] },
        { name: "بەڕێوەبردنی SEO", price: "€3.999/مانگ", desc: "باشکردنی بەردەوام", features: ["هەموو شتێک لە پشکنین +", "ستراتیژی مانگانە", "باشکردنی لەسەر لاپەڕە", "دروستکردنی بەستەری پشتەوە", "شوێنکەوتنی پلەبەندی", "ڕاپۆرتی مانگانە"], popular: true },
        { name: "SEO + گەشەپێدان", price: "€6.999/مانگ", desc: "پاکێجی تەواو", features: ["هەموو شتێک لە بەڕێوەبردن +", "گەشەپێدانی ماڵپەڕ", "دروستکردنی ناوەڕۆک", "ڕێکخستنی تەکنیکی", "یەکگرتنی تەواو", "پێداچوونەوەی وەرزانە"] }
      ],
      faqTitle: "پرسیارە باوەکانی SEO",
      faqs: [
        { q: "چەند کات تا پلەبەندی ببینم؟", a: "4-12 هەفتە بۆ باشبوونی سەرەتایی، 3-6 مانگ بۆ جوڵەی بەرچاو. Google کات دەوێت. بەڵام جارێک کار بکات، بۆ ماوەیەکی درێژ کار دەکات." },
        { q: "ئایا SEO تێچووی مانگانەیە؟", a: "بەڵێ – SEO مارەسۆنێکە، نەک ڕاکردنێکی خێرا. ئێمە پێشنیاری بەڕێوەبردنی مانگانە دەکەین (نەک یەکجار). پاراستنی پلەبەندی = باشکردنی بەردەوام." },
        { q: "دەتوانیت پلەبەندی دڵنیا بکەیتەوە؟", a: "بە جدی؟ نەخێر. کەس پلەبەندی دڵنیا ناکاتەوە. Google بەردەوام ئەلگۆریتمەکان دەگۆڕێت. ئێمە کاری باش، تاقیکردنەوە و باشکردن دڵنیا دەکەینەوە – نەک پلەی 1." },
        { q: "بۆچی تەنها ڕیکلامی Google بەکار نەهێنین؟", a: "چونکە SEO هەرزانترە. دوای 6 مانگ هێشتا پارە دەدەیت بۆ کلیکەکان لەگەڵ ڕیکلامەکان، لەگەڵ SEO بە شێوەی ئۆرگانیک کار دەکات. باشترین: هەردووکیان پێکەوە لە سەرەتا." },
        { q: "دەتوانین ماڵپەڕە ئێستامان بهێڵینەوە؟", a: "بەڵێ! ئێمە ماڵپەڕە ئێستاکەت باشتر دەکەین. هیچ گواستنەوەیەک، هیچ گواستنەوەی درێژی نییە – ئێمە هێواش هێواش بەرەوپێش دەچین." }
      ],
      ctaTitle: "دەتەوێت لە Google بینرێیت؟",
      ctaDesc: "با بە شیکارییەکی بەخۆڕایی دەست پێبکەین. ئێمە پیشانت دەدەین هەلەکانت لەکوێن.",
      ctaButton: "پشکنینی SEO دەست پێبکە",
      ctaBack: "گەڕانەوە بۆ سەرەتا",
      popularBadge: "باو",
      requestButton: "داواکاری"
    }
  };
